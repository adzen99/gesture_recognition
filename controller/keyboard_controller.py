...
import time
from utils.utils import distance2d, percentageOfNumber
...
class KeyboardController:
    ...
    def get_mouse_pos(self, event=0 , x=0, y=0):
    ...
    def create_keyboard(self):
        ...
        while True:
            ...
            if landmarks:
                ...
                if distance2d((sign_tip1_x, sign_tip1_y), (sign_tip2_x, sign_tip2_y)) < percentageOfNumber(distance2d(landmarks[0][1:3], landmarks[1][1:3]), self.percentage):
                    print('here')
            ...
            for k in keys:
                if k.is_over(self.mouse_x, self.mouse_y) or k.is_over(sign_tip1_x, sign_tip1_y):
                    ...
                    if (k.is_over(sign_tip2_x, sign_tip2_y)):
                        ...
                        if click_time - previous_click > 1:                               
                            if k.text == 'delete':
